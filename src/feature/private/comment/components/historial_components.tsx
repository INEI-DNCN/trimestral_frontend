...
import type { comentarioHistorico } from '../comment_slice';
...
export default function HistorialComentario() {
  ...
  const getTipoCambio = (item: comentarioHistorico) => {
    ...
    const tieneEstado =
      item.estado_id !== null &&
      item.estado_id !== undefined;

    if (tieneContenido && tieneEstado) {
      return 'Comentario y estado actualizados';
    }
                ...
                >
                  <Box sx={{ flex: 1 }}>
                    <Skeleton
                      ...
                      width="55%"
                      height={20}
                      sx={{ bgcolor: currentTheme.borderColor }}
                    />
                    ...
                    <Skeleton
                      ...
                      height={16}
                      sx={{
                        bgcolor: currentTheme.borderColor,
                        marginTop: '2px',
                      }}
                    />
                  </Box>
        ...
        {comentarioHistorico.map((registro, index) => {
          ...
          return (
            <Box
              key={
                registro.id ??
                `${registro.id_comentario}-${index}`
              }
              sx={{
                position: 'relative',
                marginBottom:
                  index === comentarioHistorico.length - 1
                    ? 0
                    : '20px',
              }}
            >
