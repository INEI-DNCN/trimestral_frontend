...
const DialogFilter: React.FC<Props> = ({ title,handleClose, maxWidth = 'md', open, children }) => {
	...
	return (
		<Dialog
			...
			slotProps={{
				paper: {
				sx: {
					backgroundColor: currentColors.backgroundBase,
		...
		<DialogTitle
			sx={{
				...
				fontWeight: 500, // Más suave que 600
				letterSpacing: '0.5px', // Espaciado elegante
				color: currentColors.text,
				pb: 1,
